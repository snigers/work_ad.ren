...
$arSelect = Array("ID", "IBLOCK_ID", "NAME", "DATE_ACTIVE_FROM", "PROPERTY_DIRECTION", "PROPERTY_CITY", "PROPERTY_LOGO_PREVIEW", "DETAIL_PAGE_URL");
$arFilter = Array("IBLOCK_ID"=>$arResult["IBLOCK_ID"], "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y", "PROPERTY_DIRECTION_VALUE" => "Офис");
