			...
			<blockquote class="blockquote-alt">
				<div class="blockquote-alt-content">
					...
					<div class="blockquote-alt-author">
						<p><strong><?=$arResult["PROPERTIES"]["AUTHOR"]["VALUE"]?>,</strong> <?=$arResult["PROPERTIES"]["POSITION"]["VALUE"]?>, г. <?=$arResult["PROPERTIES"]["CITY"]["VALUE"]?></p>
					</div>
				</div>
			</blockquote>
		</div>
	</div>
	<div class="h4"><?=$arResult["PROPERTIES"]["TITLE_H4"]["VALUE"]?></div>
	<?=$arResult["PROPERTIES"]["TEXT"]["~VALUE"]?>