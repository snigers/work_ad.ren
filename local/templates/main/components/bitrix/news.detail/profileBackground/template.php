...
<div class="row" id="<?= $this->GetEditAreaId($arResult['ID']); ?>">
	...
	<div class="col-6">
		<div class="page-header-bg" style="background-image: url(<?=($img["src"]) ? $img["src"] : "files/page-header-bg-vacancy-form-l.jpg"?>)"></div>
	</div>
	<?$img = CFile::ResizeImageGet($arResult["PROPERTIES"]["RIGHT_IMG_HEADER"]["VALUE"], Array("width" => 800, "height" => 420), BX_RESIZE_IMAGE_EXACT);?>
	<div class="col-6">
		<div class="page-header-bg" style="background-image: url(<?=($img["src"]) ? $img["src"] : "files/page-header-bg-vacancy-form-r.jpg"?>)"></div>
	</div>
</div>