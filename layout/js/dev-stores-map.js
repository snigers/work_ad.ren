  ...
  ymaps.ready(function () {
    ...
    var myMap = new ymaps.Map('storesMap', {
      ...
      clusterer = new ymaps.Clusterer({
         ...
         */
        clusterIcons: [{
          href: baseUrl + '/layout/images/store-pin-cluster.png',
          size: [27, 38],
          offset: [-14, -38]
        }],
    ...
    var getPointOptions = function () {
      return {
        ...
        iconImageHref: baseUrl + '/layout/images/store-pin.png',
        iconImageSize: [27, 38],
        ...
        if (typeof target.getGeoObjects != 'undefined') {
          ...
          if (type == 'mouseenter') {
            target.options.set('clusterIcons', [{
              href: baseUrl + '/layout/images/store-pin-cluster-active.png',
              size: [27, 38],
              offset: [-14, -38]
            }]);
          } else {
          ...
          if (type == 'mouseenter') {
            target.options.set('iconImageHref', baseUrl + '/layout/images/store-pin-active.png');
          } else {
            target.options.set('iconImageHref', baseUrl + '/layout/images/store-pin.png');
          }
        }
      });
