        ...
        <div class="section section-dept section-grey">
          <div class="container">
            <div class="section-content">
              ...
              <div class="h3">
				  <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array("AREA_FILE_SHOW" => "file", "PATH" => "/includes/main/titleRetailLastVax.php"));?>
              </div>
                ...
                <div class="row">
					<?$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"SORT_ORDER2" => "ASC",
							"STRICT_SECTION_CHECK" => "N",
//                            В параметр ставим название раздела (Фирменные магазины, Офис, Центр дистрибьюции) из св-ва вакансии
							"SECTION_LAST_VAC" => "Фирменный магазин"
              ...
              <div class="all-link-wrapper">
				  <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array("AREA_FILE_SHOW" => "file", "PATH" => "/includes/main/titleRetailBtn.php"));?>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="section section-dept section-white">
          <div class="container">
            <div class="section-content">
              ...
              <div class="h3">
				  <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array("AREA_FILE_SHOW" => "file", "PATH" => "/includes/main/titleOfficeLastVax.php"));?>
              </div>
              <div class="vac-list vac-list-alt">
                <div class="row">
					<?$APPLICATION->IncludeComponent(
...
//                            В параметр ставим название раздела (Фирменные магазины, Офис, Центр дистрибьюции) из св-ва вакансии
              ...
              <div class="all-link-wrapper">
				  <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array("AREA_FILE_SHOW" => "file", "PATH" => "/includes/main/titleOfficeBtn.php"));?>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="section section-dept section-grey">
          <div class="container">
            <div class="section-content">
              ...
              <div class="h3">
				  <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array("AREA_FILE_SHOW" => "file", "PATH" => "/includes/main/titleDistrLastVax.php"));?>
              </div>
              <div class="vac-list vac-list-alt">
                <div class="row">
					<?$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"STRICT_SECTION_CHECK" => "N",
//                            В параметр ставим название раздела (Фирменные магазины, Офис, Центр дистрибьюции) из св-ва вакансии
                            "SECTION_LAST_VAC" => "Центр дистрибуции"
              ...
              <div class="all-link-wrapper">
				  <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array("AREA_FILE_SHOW" => "file", "PATH" => "/includes/main/titleDistrBtn.php"));?>
              </div>
            </div>
          </div>
        </div>
